// // src/modules/notification/services/result-notification.service.ts
...
// import { ResultPublicationEventDto } from '../../result/dto/result-event.dto';
...
//     // Only process if result is published
...
//       identifierOptions: { id: event.student_id },
//       relations: { user: true, parent: { user: true } },
//     });

//     if (!student) {
//       this.logger.warn('Student not found', { student_id: event.student_id });
//       return;
//     }

//     // Fetch class details
//     const class_entity = await this.classModelAction.get({
//       identifierOptions: { id: event.class_id },
//     });

//     // Fetch term details
//     const term = await this.termModelAction.get({
//       identifierOptions: { id: event.term_id },
//     });

//     // Fetch academic session details
//     const session = await this.academicSessionModelAction.get({
//       identifierOptions: { id: event.academic_session_id },
//     });
...
//     const class_name = class_entity?.name || 'your class';
//     const term_name = term?.name || 'this term';
//     const session_name = session?.name || 'this session';
...
//       message: `Your result for ${class_name}, ${term_name} (${session_name}) has been published. Check it out now!`,
...
//     // Notify all subject teachers for this class
...
//         event,
//       });
//       // Don't throw - let the result publication succeed even if notifications fail
//     }
//   }
// }
